...
"use strict";var PowerRedact=(()=>{var g=(u,e)=>()=>(e||u((e={exports:{}}).exports,e),e.exports);var b=g((x,a)=>{var c=class{constructor(){this.version="2.0.0",this.settings={enabled:!0,autoRedactPII:!0,customPatterns:[],excludeTerms:[],revealBehavior:"cursor",blockStyle:!0,touchSupport:!0},this.redactedElements=new Set,this.isTouch="ontouchstart"in window,this.currentRevealedElement=null,this.settingsPanel=null,this.init()}init(){this.loadSettings(),this.createStyles(),this.setupEventListeners(),this.integrateWithFormatMenu(),this.settings.enabled&&this.startAutoRedaction()}loadSettings(){let e=localStorage.getItem("power-redact-settings");e&&(this.settings={...this.settings,...JSON.parse(e)})}saveSettings(){localStorage.setItem("power-redact-settings",JSON.stringify(this.settings))}createStyles(){let e=document.createElement("style");e.textContent=`
            .power-redact-hidden {
