          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Qualified Lead Alerts</Label>
                    <p className="text-xs text-muted-foreground">High-priority lead notifications</p>
                  </div>
                  <Switch
                    checked={settings.preferences?.notifications?.qualifiedLead ?? true}
                    onCheckedChange={(checked) => 
                      setSettings({
                        ...settings,
                        preferences: {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={settings.preferences?.notifications?.priceAlert ?? true}
                    onCheckedChange={(checked) => 
                      setSettings({
                        ...settings,
                        preferences: {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Automatically qualify leads</p>
                </div>
                <Switch
                  checked={settings.preferences?.automation?.leadScoring ?? true}
                  onCheckedChange={(checked) => 
                    setSettings({
                      ...settings,
                      preferences: {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Display precise address</p>
                </div>
                <Switch
                  checked={settings.preferences?.privacy?.showExactLocation ?? false}
                  onCheckedChange={(checked) => 
                    setSettings({
                      ...settings,
                      preferences: {
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Allow performance tracking</p>
                </div>
                <Switch
                  checked={settings.preferences?.privacy?.allowDataAnalytics ?? true}
                  onCheckedChange={(checked) => 
                    setSettings({
                      ...settings,
                      preferences: {
